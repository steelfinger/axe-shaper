...
> = {
  ...
  bass_r_toaster: {
    ...
    widthMm: 70.96314,
    heightMm: 26.50078,
    // Exact blue-stroke cavity path from bass-pickups.svg, including its
    // source-specific Bézier handles (not the generic rounded-rect helper).
    anchors: [
      { id: 'bass_r_toaster_a0', position: { x: -31.48099, y: -13.25039 }, handleIn: { x: -2.21632, y: 0 }, handleMode: 'corner' },
      { id: 'bass_r_toaster_a1', position: { x: 31.48099, y: -13.25039 }, handleOut: { x: 2.21632, y: 0 }, handleMode: 'corner' },
      { id: 'bass_r_toaster_a2', position: { x: 35.48157, y: -9.44689 }, handleIn: { x: 0, y: -2.10714 }, handleMode: 'corner' },
      { id: 'bass_r_toaster_a3', position: { x: 35.48157, y: 9.44689 }, handleOut: { x: 0, y: 2.10714 }, handleMode: 'corner' },
      { id: 'bass_r_toaster_a4', position: { x: 31.48099, y: 13.25039 }, handleIn: { x: 2.21632, y: 0 }, handleMode: 'corner' },
      { id: 'bass_r_toaster_a5', position: { x: -31.48099, y: 13.25039 }, handleOut: { x: -2.21632, y: 0 }, handleMode: 'corner' },
      { id: 'bass_r_toaster_a6', position: { x: -35.48157, y: 9.44689 }, handleIn: { x: 0, y: 2.10714 }, handleMode: 'corner' },
      { id: 'bass_r_toaster_a7', position: { x: -35.48157, y: -9.44689 }, handleOut: { x: 0, y: -2.10714 }, handleMode: 'corner' },
    ],
  },
  bass_r_horseshoe: {
    ...
    heightMm: 39.50052,
    anchors: [
      { id: 'bass_r_horseshoe_a0', position: { x: -62.204193, y: -19.75026 }, handleIn: { x: -4.432, y: 0 }, handleMode: 'corner' },
      { id: 'bass_r_horseshoe_a1', position: { x: 62.204193, y: -19.75026 }, handleOut: { x: 4.432, y: 0 }, handleMode: 'corner' },
      { id: 'bass_r_horseshoe_a2', position: { x: 70.204193, y: -11.75026 }, handleIn: { x: 0, y: -4.432 }, handleMode: 'corner' },
      { id: 'bass_r_horseshoe_a3', position: { x: 70.204193, y: 11.75026 }, handleOut: { x: 0, y: 4.432 }, handleMode: 'corner' },
      { id: 'bass_r_horseshoe_a4', position: { x: 62.204193, y: 19.75026 }, handleIn: { x: 4.432, y: 0 }, handleMode: 'corner' },
      { id: 'bass_r_horseshoe_a5', position: { x: -62.204193, y: 19.75026 }, handleOut: { x: -4.432, y: 0 }, handleMode: 'corner' },
      { id: 'bass_r_horseshoe_a6', position: { x: -70.204193, y: 11.75026 }, handleIn: { x: 0, y: 4.432 }, handleMode: 'corner' },
      { id: 'bass_r_horseshoe_a7', position: { x: -70.204193, y: -11.75026 }, handleOut: { x: 0, y: -4.432 }, handleMode: 'corner' },
    ],
  },
  bass_mudbucker: {
    ...
    heightMm: 43.233333,
    anchors: [
      { id: 'bass_mudbucker_a0', position: { x: -30.15208, y: -21.616667 }, handleIn: { x: -2.216, y: 0 }, handleMode: 'corner' },
      { id: 'bass_mudbucker_a1', position: { x: 30.15209, y: -21.616667 }, handleOut: { x: 2.216, y: 0 }, handleMode: 'corner' },
      { id: 'bass_mudbucker_a2', position: { x: 34.15208, y: -17.616667 }, handleIn: { x: 0, y: -2.216 }, handleMode: 'corner' },
      { id: 'bass_mudbucker_a3', position: { x: 34.15208, y: 17.616667 }, handleOut: { x: 0, y: 2.216 }, handleMode: 'corner' },
      { id: 'bass_mudbucker_a4', position: { x: 30.15209, y: 21.616667 }, handleIn: { x: 2.216, y: 0 }, handleMode: 'corner' },
      { id: 'bass_mudbucker_a5', position: { x: -30.15208, y: 21.616667 }, handleOut: { x: -2.216, y: 0 }, handleMode: 'corner' },
      { id: 'bass_mudbucker_a6', position: { x: -34.15208, y: 17.616667 }, handleIn: { x: 0, y: 2.216 }, handleMode: 'corner' },
      { id: 'bass_mudbucker_a7', position: { x: -34.15208, y: -17.616667 }, handleOut: { x: 0, y: -2.216 }, handleMode: 'corner' },
    ],
  },
  bass_mini_humbucker: {
    ...
    heightMm: 37.4125,
    anchors: [
      { id: 'bass_mini_humbucker_a0', position: { x: -40.470835, y: -18.70625 }, handleIn: { x: -2.216, y: 0 }, handleMode: 'corner' },
      { id: 'bass_mini_humbucker_a1', position: { x: 40.470825, y: -18.70625 }, handleOut: { x: 2.216, y: 0 }, handleMode: 'corner' },
      { id: 'bass_mini_humbucker_a2', position: { x: 44.470825, y: -14.70625 }, handleIn: { x: 0, y: -2.216 }, handleMode: 'corner' },
      { id: 'bass_mini_humbucker_a3', position: { x: 44.470825, y: 14.70625 }, handleOut: { x: 0, y: 2.216 }, handleMode: 'corner' },
      { id: 'bass_mini_humbucker_a4', position: { x: 40.470825, y: 18.70625 }, handleIn: { x: 2.216, y: 0 }, handleMode: 'corner' },
      { id: 'bass_mini_humbucker_a5', position: { x: -40.470835, y: 18.70625 }, handleOut: { x: -2.21599, y: 0 }, handleMode: 'corner' },
      { id: 'bass_mini_humbucker_a6', position: { x: -44.470825, y: 14.70625 }, handleIn: { x: 0, y: 2.216 }, handleMode: 'corner' },
      { id: 'bass_mini_humbucker_a7', position: { x: -44.470825, y: -14.70625 }, handleOut: { x: 0, y: -2.216 }, handleMode: 'corner' },
    ],
  },
};
